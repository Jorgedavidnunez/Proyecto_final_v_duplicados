...
public class Marca {
    ...
    public boolean buscarMarcaRepetido(String marca){
          boolean marcaRepetido = false;
          try { 
              cn = new Conexion();
              cn.abrirCon();
              String query = "SELECT Marca FROM marcas WHERE Marca = ?";
              PreparedStatement parametro;
              parametro = (PreparedStatement) cn.conexiondb.prepareStatement(query);
              parametro.setString(1, marca);
