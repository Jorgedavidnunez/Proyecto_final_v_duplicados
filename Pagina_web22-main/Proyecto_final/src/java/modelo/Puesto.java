...
public Puesto(){   
    ...
    public int modificar() {
      ...
      public boolean buscarPuestoRepetido(String puesto){
          boolean puestoRepetido = false;
          try { 
              cn = new Conexion();
              cn.abrirCon();
              String query = "SELECT Puesto FROM puestos WHERE Puesto = ?";
              PreparedStatement parametro;
              parametro = (PreparedStatement) cn.conexiondb.prepareStatement(query);
