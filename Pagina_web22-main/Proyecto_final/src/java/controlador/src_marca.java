    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          out.println("<!DOCTYPE html>");
            ...
            marca = new Marca(request.getParameter("txt_marca"),Integer.valueOf(request.getParameter("txt_id_marca")));
            if("agregar_marca".equals(request.getParameter("btn_agregar_marcas")))
            {
                boolean marcaRepetido = marca.buscarMarcaRepetido(request.getParameter("txt_marca"));
                if(marcaRepetido == true){
                    Thread.sleep(2000);
